import { Menu } from './menu.model';
  ...
  export const horizontalMenuItems = [
   ...
   // new Menu(2, 'Document', '/menu', null, null, false, 0),
    ...
    new Menu(4, 'Modifier Enveloppe', '/update', null, null, false, 87),
    new Menu(4, 'Historique', '/history', null, null, false, 87),
...
export const verticalMenuItems = [ 
    ...
    new Menu (63, 'de rénumération', '/validate', null, null, false, 86),  
